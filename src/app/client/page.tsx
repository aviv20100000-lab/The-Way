      ...
      <main className="mx-auto max-w-lg px-4 pt-4">
        ...
        {tab === "food" && (
          <div className="space-y-4">
            ...
            <input ref={foodGalleryRef} type="file" accept="image/*" webkitdirectory className="hidden"
              onChange={(e) => { const f = e.target.files?.[0]; if (f) analyzeFood(f); e.target.value = ""; }} />
          ...
          return (
            <div className="space-y-4">
              ...
              <div className="rounded-2xl bg-white p-5 shadow-sm space-y-3">
                ...
                <input ref={weightGalleryRef} type="file" accept="image/*" webkitdirectory className="hidden"
                  onChange={(e) => { const f = e.target.files?.[0]; if (f) setWeightPhoto(f); }} />
        ...
        {tab === "steps" && (
          <div className="space-y-4">
            ...
            <div className="rounded-2xl bg-white p-5 shadow-sm space-y-3">
              ...
              <input ref={stepsGalleryRef} type="file" accept="image/*" webkitdirectory className="hidden"
                onChange={(e) => { const f = e.target.files?.[0]; if (f) uploadStepsScreenshot(f); e.target.value = ""; }} />
