...
const COOKING_STATES = new Set([
  ...
  "מבושלים", "מבושלות", "מטוגנים", "מטוגנות", "צלויים", "צלויות", "אפויים", "אפויות",
  "מאודה", "מאודים", "מאודות",
]);
...
const COOKING_STATE_INFLECTIONS: Record<string, readonly string[]> = {
  ...
  מבושלים: ["מבושל", "מבושלת", "מבושלים", "מבושלות"],
  מבושלות: ["מבושל", "מבושלת", "מבושלים", "מבושלות"],
  מטוגן: ["מטוגן", "מטוגנת", "מטוגנים", "מטוגנות"],
  מטוגנת: ["מטוגן", "מטוגנת", "מטוגנים", "מטוגנות"],
  מטוגנים: ["מטוגן", "מטוגנת", "מטוגנים", "מטוגנות"],
  מטוגנות: ["מטוגן", "מטוגנת", "מטוגנים", "מטוגנות"],
  צלוי: ["צלוי", "צלויה", "צלויים", "צלויות"],
  צלויה: ["צלוי", "צלויה", "צלויים", "צלויות"],
  צלויים: ["צלוי", "צלויה", "צלויים", "צלויות"],
  צלויות: ["צלוי", "צלויה", "צלויים", "צלויות"],
  אפוי: ["אפוי", "אפויה", "אפויים", "אפויות"],
  אפויה: ["אפוי", "אפויה", "אפויים", "אפויות"],
  אפויים: ["אפוי", "אפויה", "אפויים", "אפויות"],
  אפויות: ["אפוי", "אפויה", "אפויים", "אפויות"],
